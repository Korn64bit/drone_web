...
const customers = [
    { id: 65010131, name: "Jiratanatkorn", birthdate: "2003-11-09" },
];

app.use(express.json());
app.use(express.static('web')); // Serve static files from the public directory
...
app.get("/logs", async (req, res) => {
    try {
        ...
        // Sort logs by 'created' date in descending order
